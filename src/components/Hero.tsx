...
const Hero = () => {
  return (
    <div className="py-5 sm:py-8 md:py-10 bg-brand-10 px-5 sm:px-10 md:px-14">
      <div className="grid grid-cols-1 gap-y-6 sm:gap-x-5 sm:grid-cols-5">
        ...
        <div className="max-w-xl mx-auto sm:mx-0 sm:max-w-full col-span-3 flex flex-col justify-center text-center sm:text-left items-center sm:items-start">
          <h1 className="max-w-sm sm:max-w-full text-white capitalize leading-[45px] sm:leading-[50px] font-[600] tracking-tight   text-[30px] xs:text-[36px] sm:text-[40px] md:text-5xl">
